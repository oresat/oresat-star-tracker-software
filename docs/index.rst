...
- star tracker module -- solves images (based on `OpenStarTracker <http://openstartracker.org/>`_ from the University at Buffalo)
...
.. automodule:: src.startracker.startracker
   :members:

.. automodule:: src.camera.camera
   :members: